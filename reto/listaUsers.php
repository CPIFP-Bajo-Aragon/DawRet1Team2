            ...
            <button id="add-btn" onclick="window.modal.showModal();">Añadir Usuario</button>
              ...
              <h3>AÑADIR USUARIO <button  onclick="window.modal.close();"> X </button></h3><br>
                ...
                <?php
                  ...
                  foreach ($data as $valores):
                    echo '<tr><td>'. $valores['Nom_Usuario'] .'</td><td>'. $valores['Nombre_Completo'] .'</td><td>'. $valores['Nombre_Rol'] .'</td><td>'. $valores['Correo_Usuario'] .'</td><td>'. $valores['Nombre_Departamento'] .'</td><td><a onclick="confirmar(event)" href="borrarUsuario.php?id='.$valores["ID_Usuario"].'"><img src="images/icons8-eliminar-96.png" height="32px" "></a></td></tr>';
                  endforeach;
