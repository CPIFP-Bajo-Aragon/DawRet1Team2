...
<div class="pagina">
            ...
            <button id="add-btn" onclick="window.modal.showModal();">Añadir Pantalla</button>
              ...
              <form action="funcionAddPantalla.php" method="post">
                  ...
                  <input type="text" name="ubi" id=""><br><br>
                ...
                <?php
                  ...
                  foreach ($data as $valores):
                    echo '<tr><td>'. $valores['Nombre'] .'</td><td>'. $valores['Identificador'] .'</td><td>'. $valores['Ubicacion'] .'</td><td><a onclick="confirmar(event)" href="borrarPantalla.php?id='.$valores["ID_Pantalla"].'"><img src="images/icons8-eliminar-96.png" height="32px""></a></td></tr>';
                  endforeach;
