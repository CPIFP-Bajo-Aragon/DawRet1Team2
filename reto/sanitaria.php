  ...
  <div class="submenu">
      ...
      <div  class="contenedor">
        ...
        <div class="contenido">
          ...
          <h2>PUBLICACIONES DE SANITARIA</h2>
            ...
            <?php
              ...
              //Consulta
              $consulta=$db->prepare("SELECT ID_Publicacion, Titulo, Descripcion, Multimedia, Tipo_Publicacion, Estado, Ubicacion, Fecha_Inicio, Fecha_Fin, Publicacion.ID_Usuario as ID_Usuario, Usuario.Nom_Usuario as Nom_Usuario FROM Publicacion, Usuario WHERE Usuario.ID_Usuario=Publicacion.ID_Usuario AND Fecha_Fin>=CURRENT_DATE() and Ubicacion='Sanitaria' and Estado='Aceptada' and Fecha_Inicio<=CURRENT_DATE() ORDER BY Fecha_Fin");
              $consulta->execute();
